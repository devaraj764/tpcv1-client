        ...
        <>
            <Row className="Home justify-content-md-center" style={{ backgroundImage: "url('https://img.freepik.com/free-vector/white-abstract-background_23-2148810113.jpg?w=2000')" }}>
                <Col className="right-side" sm={12} md={8} style={{ padding: '0 10px' }}>
                    ...
                    <a href="https://rguktsklm.ac.in" target="_blank" rel="noopener noreferrer" style={{ fontSize: '16px', fontWeight: 'bold', color: '#625bf6', textAlign: 'center', textDecoration: 'none' }}>Ragiv Gandhi University of Knowledge Technologies Srikakulam</a>
